...
func draw_glyph() -> void:
	...
	var _glyph_char: String = " " if char.char == "\t" else char.char
	__parent.draw_texture_rect_region(font.texture, char.glyph, (font.glyphs[_glyph_char] as IGlyph).rect, glyph.color)
